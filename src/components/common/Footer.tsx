...
export function Footer() {
  return (
    ...
    <div className="w-full rounded-[3rem] bg-[#4A69E2]">
        {/* Newsletter Section */}
      <div className=" px-6 py-16 md:px-12 md:pt-20 lg:px-24 rounded-[3rem] md:rounded-[4rem] mx-4 mb-4">
      ...
      {/* Main Footer Content */}
      <div className="rounded-[3rem]  bg-[#232321] px-6 pt-8 md:px-12 md:pt-24 lg:px-24 ">
        ...
        <div className="mt-20 flex w-full items-center justify-center overflow-hidden">
