...
export function StatusView({ type, message, onRetry, className }: StatusViewProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        isError ? "bg-red-50 text-red-500" : "bg-zinc-100 text-zinc-400"
      )}>
        {isError ? (
      ...
      <h3 className="text-xl font-black uppercase tracking-tight text-zinc-900">
        {isError ? "Something went wrong" : "No products found"}
      </h3>
